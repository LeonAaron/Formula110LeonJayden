"""Parameter-search and diagnostic tool for controllers.reactive_v3.ReactiveParams.

v3 counterpart of scripts/optimize_reactive.py, pointed at
controllers.reactive_v3 (off-axis wall detection) instead of
controllers.reactive. controllers.reactive and scripts/optimize_reactive.py
